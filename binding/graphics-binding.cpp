...
DEF_GRA_PROP_I(FastForward)
DEF_GRA_PROP_F(ShaderTimeScale)
...
void graphicsBindingInit()
{
    ...
    INIT_GRA_PROP_BIND( FastForward,      "fast_forward"       );
    INIT_GRA_PROP_BIND( ShaderTimeScale,  "shader_time_scale"  );
